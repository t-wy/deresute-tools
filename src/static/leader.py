...
SKILL_BASE = {0: "",
              ...
              128: "Tricolor Unison",
              129: "Tricolor Unison",
              130: "Dominant Duet Voice(Cu)&Step(Co)",
              131: "Dominant Duet Step(Cu)&Make(Co)",
              132: "Dominant Duet Make(Cu)&Voice(Co)",
              133: "Dominant Duet Voice(Cu)&Step(Pa)",
              134: "Dominant Duet Step(Cu)&Make(Pa)",
              135: "Dominant Duet Make(Cu)&Voice(Pa)",
              136: "Dominant Duet Voice(Co)&Step(Cu)",
              137: "Dominant Duet Step(Co)&Make(Cu)",
              138: "Dominant Duet Make(Co)&Voice(Cu)",
              139: "Dominant Duet Voice(Co)&Step(Pa)",
              140: "Dominant Duet Step(Co)&Make(Pa)",
              141: "Dominant Duet Make(Co)&Voice(Pa)",
              142: "Dominant Duet Voice(Pa)&Step(Cu)",
              143: "Dominant Duet Step(Pa)&Make(Cu)",
              144: "Dominant Duet Make(Pa)&Voice(Cu)",
