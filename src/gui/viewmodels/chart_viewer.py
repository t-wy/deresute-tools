...
from PyQt5.QtWidgets import QWidget, QVBoxLayout, QLabel, QScrollArea, QStackedWidget, QLineEdit, QHBoxLayout, QGridLayout, \
    QRadioButton, QButtonGroup, QSizePolicy, QTreeWidget, QTreeWidgetItem, QCheckBox, QPushButton, QSpinBox, QTextEdit, QSpacerItem
...
class ChartViewer:
    ...
    def show_detail_skill_info(self, skill_type, time):
        ...
        self.info_widget.skill_prob_line.setText("{:.0%}".format(self.skill_probability[card_idx]))
        ...
        if skill_type == 16: #encore
            ...
            if idx in self.perfect_detail.amr_bonus[card_idx]:
    ...
    def _setup_skill_info(self):
        ...
        self.info_widget.skill_detail_encore_line.setText("[1] Visual Motif")
        ...
        self.info_widget.skill_detail_encore_line_.setText("9.0")
        ...
        self.info_widget.skill_detail_magic_layout = QGridLayout(self.info_widget.skill_detail_magic_widget)
        ...
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_tap_label, 0, 0)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_tap_line, 1, 0)
        ...
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_long_label, 0, 1, 1, 2)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_long_line, 1, 1, 1, 2)
        ...
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_flick_label, 0, 3)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_flick_line, 1, 3)
        ...
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_slide_label, 0, 4)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_slide_line, 1, 4)
        ...
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_great_label, 0, 5)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_great_line, 1, 5)
        ...
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_combo_label, 0, 6)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_combo_line, 1, 6)
        ...
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_life_label, 0, 7)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_life_line, 1, 7)
        ...
        self.info_widget.skill_detail_magic_boost_cute_score_line = QLineEdit()
        self.info_widget.skill_detail_magic_boost_cute_score_line.setReadOnly(True)
        self.info_widget.skill_detail_magic_boost_cute_score_line.setAlignment(Qt.AlignCenter)
        self.info_widget.skill_detail_magic_boost_cute_combo_line = QLineEdit()
        self.info_widget.skill_detail_magic_boost_cute_combo_line.setReadOnly(True)
        self.info_widget.skill_detail_magic_boost_cute_combo_line.setAlignment(Qt.AlignCenter)
        self.info_widget.skill_detail_magic_boost_cute_life_line = QLineEdit()
        self.info_widget.skill_detail_magic_boost_cute_life_line.setReadOnly(True)
        self.info_widget.skill_detail_magic_boost_cute_life_line.setAlignment(Qt.AlignCenter)
        self.info_widget.skill_detail_magic_boost_cute_support_line = QLineEdit()
        self.info_widget.skill_detail_magic_boost_cute_support_line.setReadOnly(True)
        self.info_widget.skill_detail_magic_boost_cute_support_line.setAlignment(Qt.AlignCenter)
        self.info_widget.skill_detail_magic_boost_cool_score_line = QLineEdit()
        self.info_widget.skill_detail_magic_boost_cool_score_line.setReadOnly(True)
        self.info_widget.skill_detail_magic_boost_cool_score_line.setAlignment(Qt.AlignCenter)
        self.info_widget.skill_detail_magic_boost_cool_combo_line = QLineEdit()
        self.info_widget.skill_detail_magic_boost_cool_combo_line.setReadOnly(True)
        self.info_widget.skill_detail_magic_boost_cool_combo_line.setAlignment(Qt.AlignCenter)
        self.info_widget.skill_detail_magic_boost_cool_life_line = QLineEdit()
        self.info_widget.skill_detail_magic_boost_cool_life_line.setReadOnly(True)
        self.info_widget.skill_detail_magic_boost_cool_life_line.setAlignment(Qt.AlignCenter)
        self.info_widget.skill_detail_magic_boost_cool_support_line = QLineEdit()
        self.info_widget.skill_detail_magic_boost_cool_support_line.setReadOnly(True)
        self.info_widget.skill_detail_magic_boost_cool_support_line.setAlignment(Qt.AlignCenter)
        self.info_widget.skill_detail_magic_boost_passion_score_line = QLineEdit()
        self.info_widget.skill_detail_magic_boost_passion_score_line.setReadOnly(True)
        self.info_widget.skill_detail_magic_boost_passion_score_line.setAlignment(Qt.AlignCenter)
        self.info_widget.skill_detail_magic_boost_passion_combo_line = QLineEdit()
        self.info_widget.skill_detail_magic_boost_passion_combo_line.setReadOnly(True)
        self.info_widget.skill_detail_magic_boost_passion_combo_line.setAlignment(Qt.AlignCenter)
        self.info_widget.skill_detail_magic_boost_passion_life_line = QLineEdit()
        self.info_widget.skill_detail_magic_boost_passion_life_line.setReadOnly(True)
        self.info_widget.skill_detail_magic_boost_passion_life_line.setAlignment(Qt.AlignCenter)
        self.info_widget.skill_detail_magic_boost_passion_support_line = QLineEdit()
        self.info_widget.skill_detail_magic_boost_passion_support_line.setReadOnly(True)
        self.info_widget.skill_detail_magic_boost_passion_support_line.setAlignment(Qt.AlignCenter)
        spacer = QSpacerItem(1, 8)
        self.info_widget.skill_detail_magic_layout.addItem(spacer, 3, 0)
        spacer = QSpacerItem(5, 1)
        self.info_widget.skill_detail_magic_layout.addItem(spacer, 4, 2, 4, 1)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_boost_cute_label, 5, 3)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_boost_cool_label, 6, 3)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_boost_passion_label, 7, 3)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_boost_score_label, 4, 4)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_boost_combo_label, 4, 5)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_boost_life_label, 4, 6)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_boost_support_label, 4, 7)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_boost_cute_score_line, 5, 4)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_boost_cute_combo_line, 5, 5)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_boost_cute_life_line, 5, 6)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_boost_cute_support_line, 5, 7)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_boost_cool_score_line, 6, 4)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_boost_cool_combo_line, 6, 5)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_boost_cool_life_line, 6, 6)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_boost_cool_support_line, 6, 7)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_boost_passion_score_line, 7, 4)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_boost_passion_combo_line, 7, 5)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_boost_passion_life_line, 7, 6)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_boost_passion_support_line, 7, 7)
        ...
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_psupport_label, 4, 0, 1, 2)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_psupport_line, 5, 0, 1, 2)
        ...
        self.info_widget.skill_detail_magic_csupport_line.setAlignment(Qt.AlignBottom)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_csupport_label, 6, 0, 1, 2)
        self.info_widget.skill_detail_magic_layout.addWidget(self.info_widget.skill_detail_magic_csupport_line, 7, 0, 1, 2)
        for _ in range(self.info_widget.skill_detail_magic_layout.columnCount()):
            self.info_widget.skill_detail_magic_layout.setColumnStretch(_, 10)
        self.info_widget.skill_detail_magic_layout.setColumnStretch(1, 7)
        self.info_widget.skill_detail_magic_layout.setColumnStretch(2, 2)
        _ = QLineEdit()
        self.info_widget.skill_detail_magic_layout.addWidget(_, 4, 3)
        _.setMaximumWidth(0)
    ...
    def _setup_skill_detail_info(self):
        pass
