...
class CustomSettingsView:
    ...
    def _define_components_1(self):
        ...
        self.autoplay_offset_text.setValidator(QIntValidator(0, 1000, None))  # Only number allowed
        self.custom_appeal_text = QtWidgets.QLineEdit(self.main)
        self.custom_appeal_text.setValidator(QIntValidator(0, 1000000, None))  # Only number allowed
        self.custom_appeal_text.setPlaceholderText("Total appeals")
        self.custom_support_text = QtWidgets.QLineEdit(self.main)
        self.custom_support_text.setValidator(QIntValidator(0, 1000000, None))  # Only number allowed
